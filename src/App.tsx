...
import SlideRefs from "./Slides/refs";

function App() {
  const [currentSlide, setCurrentSlide] = useState(0);

  const slides = [Slide1, Slide2, Slide3, Slide4, Slide6, Slide67, Slide7, Slide8, Slide9, Slide10, Slide11, Slide12, Slide13, Slide14, Slide15, SlideRefs, Slide16];
